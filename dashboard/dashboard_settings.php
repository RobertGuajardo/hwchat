...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'save') {
        try {
            ...
            // Parse allowed origins (one per line)
            ...
            $insertRule = $db->prepare('
                INSERT INTO availability_rules (tenant_id, day_of_week, start_time, end_time)
                VALUES (:tid, :dow, :start, :end)
            ');

            for ($dow = 0; $dow <= 6; $dow++) {
                $enabled = !empty($_POST["avail_day_{$dow}_enabled"]);
                if ($enabled) {
...
?>
    <main class="container" style="max-width:800px;">
        ...
        <form method="POST">
            ...
            <!-- Embed Code -->
            <div class="embed-box" style="margin-bottom:32px;">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <p class="form-hint">Shown in the chat header (e.g. "Acme AI Assistant")</p>
                </div>
                <div class="form-group">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <div style="display:flex;gap:8px;align-items:center;">
                            <input type="color" name="accent_color_picker" value="<?php echo e($tenant['accent_color']); ?>"
                                   style="width:40px;height:36px;border:none;background:none;cursor:pointer;padding:0;"
                                   onchange="document.querySelector('[name=accent_color]').value=this.value">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="accent_gradient" class="form-input" value="<?php echo e($tenant['accent_gradient'] ?? ''); ?>">
                    </div>
                    <div class="form-group">
                        <label class="form-label">AI Accent (links)</label>
                        <input type="text" name="ai_accent" class="form-input" value="<?php echo e($tenant['ai_accent'] ?? '#8B5CF6'); ?>">
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea name="system_prompt" class="form-textarea" style="min-height:240px;"><?php echo e($tenant['system_prompt'] ?? ''); ?></textarea>
                    <p class="form-hint">This defines your chatbot's personality, knowledge, and behavior. Be specific about your business, services, and how to handle leads.</p>
                </div>
                <div class="form-row">
                    <div class="form-group">
            ...
            <div class="form-section">
                <h3>API KEYS</h3>
                <p class="form-hint" style="margin-top:-8px;margin-bottom:16px;">Optional — if blank, default shared keys are used (usage limits apply).</p>
                <div class="form-group">
            ...
            <div class="form-section">
                ...
                <p class="form-hint" style="margin-top:-8px;margin-bottom:16px;">Route leads to HubSpot with conversation context. Uses the HubSpot Forms API.</p>
                <div class="form-row">
                    <div class="form-group">
            ...
            <!-- Cecilian XO Property Feed -->
            <div class="form-section">
                <h3>PROPERTY INVENTORY (Cecilian XO)</h3>
                <p class="form-hint" style="margin-top:-8px;margin-bottom:16px;">Connect the chatbot to live property inventory from the Cecilian XO API. When enabled, the AI can search and present available homes during conversations.</p>
                <div class="form-group">
            ...
            <div class="form-section">
                ...
                <p class="form-hint" style="margin-top:-8px;margin-bottom:16px;">Metadata for cross-community features and portfolio-level intelligence.</p>
                <div class="form-row">
                    <div class="form-group">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea name="allowed_origins" class="form-textarea" style="min-height:80px;"><?php echo e(implode("\n", $tenant['allowed_origins'])); ?></textarea>
        ...
        <!-- Builders Management (separate forms for add/remove) -->
